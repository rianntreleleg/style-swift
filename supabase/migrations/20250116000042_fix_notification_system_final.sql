...
-- ======================================
-- 1. GARANTIR QUE AS TABELAS EXISTEM E ESTÃO CORRETAS
-- ======================================
...
-- Garantir que a tabela notification_settings existe
...
BEGIN
    ...
    RAISE NOTICE 'SISTEMA DE NOTIFICAÇÕES FINALIZADO:';
