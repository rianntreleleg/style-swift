-- CORREÇÃO MANUAL DO FLUXO DE PAGAMENTO
...
-- 9. VERIFICAR SUBSCRIBERS
SELECT
  'Subscribers status' as status,
  COUNT(*) as total_subscribers,
  COUNT(CASE WHEN subscribed = true THEN 1 END) as active_subscribers,
  COUNT(CASE WHEN subscription_tier IN ('essential', 'professional', 'premium') THEN 1 END) as correct_tiers
